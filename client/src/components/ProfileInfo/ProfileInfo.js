...
const ProfileInfo = ({ navigation, context }) => {
    return (
        <View style={styles.description}>
            <ListItem style={styles.header}>
                ...
                />
                <ListItem.Content style={styles.infos}>
                    <View style={styles.informations}>
                        <ListItem.Title style={{ fontWeight: 'bold', color: colors.lightBlack }}>100</ListItem.Title>
                        <ListItem.Title style={{ color: colors.lightGray }}>Posts</ListItem.Title>
                    </View>
                </ListItem.Content>
                <ListItem.Content style={styles.infos}>
                    <View style={styles.informations}>
                        <ListItem.Title
                            style={{ fontWeight: 'bold', color: colors.lightBlack }}
                            onPress={() => navigation.navigate('Followers', { followers: 'following', context })}
                        >
                            10000</ListItem.Title>
                        <ListItem.Title style={{ color: colors.lightGray }}>Following</ListItem.Title>
                    </View>
                </ListItem.Content>
                <ListItem.Content style={styles.infos}>
                    <View style={styles.informations}>
                        <ListItem.Title
                            style={{ fontWeight: 'bold', color: colors.lightBlack }}
                            onPress={() => navigation.navigate('Followers', { followers: 'followers', context })}
                        >
                            50000</ListItem.Title>
                        <ListItem.Title style={{ color: colors.lightGray }}>Followers</ListItem.Title>
                    </View>
                </ListItem.Content>
            </ListItem>
            <SafeAreaView style={styles.bio}>
                <Text style={{ fontSize: 20, fontWeight: '500', marginBottom: 10, color: colors.lightBlack }}>Username</Text>
                <Text style={{ lineHeight: 30, width: width * 0.7, color: colors.lightGray }}>This part is meant for user Bio and to reprensent what the user hobbies and intensions are...😋🤞</Text>
