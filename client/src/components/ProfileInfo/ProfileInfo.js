            ...
            <View style={styles.description}>
                <View style={styles.header}>
                    ...
                    <View style={styles.informations}>
                        <Text style={styles.numerics}>1000</Text>
                        <Text>Posts</Text>
                    </View>
                    <View style={styles.informations}>
                        <Text style={styles.numerics}>10000</Text>
                        <Text>Following</Text>
                    </View>
                    <View style={styles.informations}>
                        <Text style={styles.numerics}>50000</Text>
                        <Text>Followers</Text>
                    </View>
                </View>
                <View style={styles.bio}>
                    <Text style={{fontSize: 15, marginBottom: 5}}>Username</Text>
                    <Text>description bio...</Text>
                    <Text>description bio...</Text>
                    <Text style={{color: 'blue'}}>https://www.facebook.com</Text>
                </View>
            </View>
        </View>
    )
