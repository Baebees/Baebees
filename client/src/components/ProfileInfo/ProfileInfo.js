    ...
    return (
            <View style={styles.description}>
                <ListItem style={styles.header}>
                    ...
                    <ListItem.Content style={styles.infos}>
                        <View style={styles.informations}>
                            <ListItem.Title style={{ fontWeight: 'bold', color: colors.lightBlack}}>10000</ListItem.Title>
                            <ListItem.Title style={{color: colors.lightGray}}>Following</ListItem.Title>
                        </View>
                    </ListItem.Content>
                    <ListItem.Content style={styles.infos}>
                        <View style={styles.informations}>
                            <ListItem.Title style={{ fontWeight: 'bold', color: colors.lightBlack}}>50000</ListItem.Title>
