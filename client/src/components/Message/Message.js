...
const Message = ({ sender, messager, textField }) => {
    return (
            <View>
                <Text style={styles.date}>18:30</Text>
            <View style={styles[messager]}>
            {sender == 'owner' && <Text style={styles[textField]}>Hello qdqdbqdbqdbqdbqdbqdb</Text>}
                <Avatar
                    rounded
                    activeOpacity={0.7}
                ...
                />
                {sender == "friend" && <Text style={styles[textField]}>Hello qdqdbqdbqdbqdbqdbqdb</Text>}
            </View>
            </View>
    )
}
